    ...
    <div class="main-serch">
      ...
      >
        ...
        <el-form-item label="适用地区：">
          <AreaComponent :province-data="provinceData" :ComboSerch="ComboSerch" :city-data="cityData"></AreaComponent>  
        </el-form-item>
...
<script>
import AreaComponent from "../components/AreaComponents.vue";
export default {
  name: "MedicalCombo",
  components: {
    AreaComponent,
  ...
  methods: {
    ...
    getComboList() {
      ...
      //   url: "/org/getOrgList",
      //   methods: "post",
      //   baseURL: "http://47.102.206.221/garbage/api/",
      //   transformRequest: [
